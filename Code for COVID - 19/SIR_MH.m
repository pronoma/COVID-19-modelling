...
j=1;
%Initialising the MH column with the first row containing initial confirmed
%case
i=1;
%Initialising the MH column with second-row containing initial recovered
%case
k=2;
confirmed (j) =0;
recovered (j) =0;
...
%N is the assumed exposed population in MAH
N=100000000;
...
%d1 to "d2" variable using SIR Model
...
%Plotting the predicted data along with the actual data
 ...
 ylim([-5000000 110000000]);
 
 title('Predicted Data(MAH)');
 ylabel('Population');
